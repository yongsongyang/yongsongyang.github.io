...
**3D Image Segmentation based on Distilled Separate Anything Model (Feb 2025 - Mar 2025)**  
...
**Mamba-UNet for 3D Segmentation via Cross Semi-Supervised Learning (Jan 2025 - Feb 2025)**  
...
**Adaptive Fine-tuning of YOLOv11 for Robust Person Detection in Dynamic scenes (Dec 2024 – Feb 2025)**  
...
**Dual-timescale Joint Estimation for Battery States based on Transfer Learning (Nov 2022 – Feb 2024)**  
...
**Sparse Data Reconstruction based on Masked Auto-Encoder with extrapolator (Jul 2022 – Jun 2023)**  
...
**Battery State-of-Charge Estimation based on Cross Domain Transfer Learning (Jul 2021 – Jun 2022)**  
